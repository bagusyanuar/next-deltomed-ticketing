...
import { getDivisionData } from '../../redux/features/divisionSlice'
...
export class Division extends Component {
    ...
    handleSave = async (e) => {
        const resp = await this.props.getDivisionData(AxiosInstance)
        console.log(resp);
    }
    render() {
        return (
...
const mapDispatchToProps = { getDivisionData }
