...
function SidebarItem({ icon, title, link, active }) {
    return (
        <Link href={link} className={`flex items-center ${active ? 'bg-green-500' : 'hover:bg-slate-100'} cursor-pointer h-[45px] rounded-md mb-1 pl-3 sm:pl-0 md:pl-3 lg:pl-3 sm:justify-center md:justify-start lg:justify-start`}>
